...
- `Scripts/`: contains the Python scripts described in the previous sections, used to generate bitmaps (in form of C buffers) from displaying images and rendering fonts.
