# 1 "Source/Libs/RIT/rit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/RIT/rit.c" 2
...
# 5 "Source/Libs/RIT/rit.c" 2


static const u32 rit_clk_mhz = 100;

extern void allocate_jobs_array(u8);
extern void free_jobs_array(void);
...
void RIT_Init(u32 ival_ms, u16 int_priority)
{
    ...
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOMPVAL = (rit_clk_mhz * ival_ms * 1000);
    ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL = 6;
    ...
    if (!(((int)int_priority) <= INT_PRIO_DEF) && ((int_priority) >= (0) && (int_priority) <= (15)))
        __NVIC_SetPriority(RIT_IRQn, int_priority);
}
...
_Bool RIT_IsEnabled(void)
{
    return ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL & (1 << 3);
}
