# 1 "Source/Libs/LED/led.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/LED/led.c" 2
...
# 3 "Source/Libs/LED/led.c" 2

void LED_Init(void)
{
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= 0xFFFF0000;
...
{
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOSET = which;
}

void LED_Off(u8 which)
{
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = which;
}
...
void LED_Clear(void)
{
    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = LED_ALL;
}
