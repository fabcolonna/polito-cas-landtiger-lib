# 1 "Source/Libs/ADC-PM/adc_pm_irq.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/ADC-PM/adc_pm_irq.c" 2
...
# 2 "Source/Libs/ADC-PM/adc_pm_irq.c" 2
...
# 3 "Source/Libs/ADC-PM/adc_pm_irq.c" 2
...
# 4 "Source/Libs/ADC-PM/adc_pm_irq.c" 2


static ADC_PMInterruptHandler done_action = 0;


static u16 prv_value = 0x0;
...
extern void ADC_IRQHandler(void)
{
    ...
    const u16 new_value = (((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADGDR >> 4) & 0xFFF;
