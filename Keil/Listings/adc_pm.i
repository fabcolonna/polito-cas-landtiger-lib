# 1 "Source/Libs/ADC-PM/adc_pm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/ADC-PM/adc_pm.c" 2
...
# 2 "Source/Libs/ADC-PM/adc_pm.c" 2
...
# 3 "Source/Libs/ADC-PM/adc_pm.c" 2
...
# 4 "Source/Libs/ADC-PM/adc_pm.c" 2
...
# 6 "Source/Libs/ADC-PM/adc_pm.c" 2
...
void ADC_PMInit(u8 options, u8 clock_divider, u8 int_priority)
{
    ...
    (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 |= ((0x3) << 30));
    ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADCR = (1 << 21) | (clock_divider << 8) | (1 << 5);

    ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADINTEN = (1 << 8);
    __NVIC_EnableIRQ(ADC_IRQn);

    if (!(((int)int_priority) <= INT_PRIO_DEF) && ((int_priority) >= (0) && (int_priority) <= (15)))
        __NVIC_SetPriority(ADC_IRQn, int_priority);
...
void ADC_PMDeinit(void)
{
    ...
    RIT_RemoveJob(ADC_PMGetSample);

    __NVIC_DisableIRQ(ADC_IRQn);
    ((LPC_ADC_TypeDef *) ((0x40000000UL) + 0x34000) )->ADCR = 0;
