# 1 "Source/Libs/Button/button.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/Button/button.c" 2
...
# 6 "Source/Libs/Button\\button.h" 2
...
# 2 "Source/Libs/Button/button.c" 2
...
# 3 "Source/Libs/Button/button.c" 2
...
# 5 "Source/Libs/Button/button.c" 2



volatile _Bool debouncer_on = 0;


extern void handle_debouncing(void);
...
void BUTTON_Init(u8 options, u8 eint0_priority, u8 eint1_priority, u8 eint2_priority)
{
    ...
    ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 |= (0b010101 << 20);


    ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= ~(0b111 << 10);
    ...
    if (!(((int)eint0_priority) <= INT_PRIO_DEF) && ((eint0_priority) >= (0) && (eint0_priority) <= (15)))
        __NVIC_SetPriority(RIT_IRQn, eint0_priority);

    if (!(((int)eint1_priority) <= INT_PRIO_DEF) && ((eint1_priority) >= (0) && (eint1_priority) <= (15)))
        __NVIC_SetPriority(RIT_IRQn, eint1_priority);

    if (!(((int)eint2_priority) <= INT_PRIO_DEF) && ((eint2_priority) >= (0) && (eint2_priority) <= (15)))
        __NVIC_SetPriority(RIT_IRQn, eint2_priority);
