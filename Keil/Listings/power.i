# 1 "Source/Libs/Power/power.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/Power/power.c" 2
...
# 3 "Source/Libs/Power/power.c" 2

void POWER_Init(u8 config)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (config & POWR_CFG_SLEEP_ON_EXIT);
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (config & POWR_CFG_DEEP);
}

void POWER_SleepOnWFI(void)
{
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON &= ~0x3;
}

void POWER_PowerDownOnWFI(void)
{
    (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON |= (1 << 0));
}
...
void POWER_TurnOnPeripheral(u8 bit)
{
    (((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1 << bit));
}
