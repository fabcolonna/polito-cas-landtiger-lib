# 1 "Source/Libs/RIT/rit_job.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/RIT/rit_job.c" 2
...
# 6 "Source/Libs/RIT/rit_job.c" 2




static RIT_InterruptJob jobs[10] = {0};
static u8 jobs_sz = 0;
...
extern void RIT_IRQHandler(void)
{
    ...
    (((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICTRL |= (1 << 0));
}
