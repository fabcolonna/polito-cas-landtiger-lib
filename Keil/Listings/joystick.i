# 1 "Source/Libs/Joystick/joystick.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/Joystick/joystick.c" 2
...
# 5 "Source/Libs/Joystick\\joystick_types.h" 2
...
# 2 "Source/Libs/Joystick/joystick.c" 2
...
# 3 "Source/Libs/Joystick/joystick.c" 2
...
# 4 "Source/Libs/Joystick/joystick.c" 2
...
# 6 "Source/Libs/Joystick/joystick.c" 2


static JOYSTICK_Function functions[JOY_ACTION_COUNT] = {0};



static void handle_polling(void)
{
    if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 29)) == 0 && functions[JOY_ACTION_UP])
        functions[JOY_ACTION_UP]();

    if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 25)) == 0 && functions[JOY_ACTION_SEL])
        functions[JOY_ACTION_SEL]();

    if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 26)) == 0 && functions[JOY_ACTION_DOWN])
        functions[JOY_ACTION_DOWN]();

    if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 27)) == 0 && functions[JOY_ACTION_LEFT])
        functions[JOY_ACTION_LEFT]();

    if ((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIOPIN & (1 << 28)) == 0 && functions[JOY_ACTION_RIGHT])
