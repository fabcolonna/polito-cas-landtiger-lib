# 1 "Source/Libs/Timer/timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/Timer/timer.c" 2
...
# 5 "Source/Libs/Timer\\timer_types.h" 2
...
# 6 "Source/Libs/Timer/timer.c" 2



static void set_match_reg(LPC_TIM_TypeDef *const timer, const TIMER_MatchRegister match_reg)
{
...
static void unset_match_reg(LPC_TIM_TypeDef *const timer, const TIMER_MatchRegister match_reg)
{
    switch (match_reg.which)
    {
    case 0:
...
void TIMER_Init(TIMER *timer, u8 which, u32 prescaler, u8 int_priority)
{
    ...
    _Bool valid_prio = !(((int)int_priority) <= INT_PRIO_DEF) && ((int_priority) >= (0) && (int_priority) <= (15));
    _Bool valid_prescaler = !(((int)prescaler) <= 0);
    ...
    case 0:
        ...
        if (valid_prio)
            __NVIC_SetPriority(TIMER0_IRQn, int_priority);
        break;
    case 1:
        ...
        if (valid_prio)
            __NVIC_SetPriority(TIMER1_IRQn, int_priority);
        break;
    case 2:
        ...
        if (valid_prio)
            __NVIC_SetPriority(TIMER2_IRQn, int_priority);
        break;
    case 3:
        ...
        if (valid_prio)
            __NVIC_SetPriority(TIMER3_IRQn, int_priority);
        break;
    default:
        timer = 0;
    }
...
void TIMER_Deinit(TIMER timer)
{
    ...
    case 0:
        ...
        clear_match_regs(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) ));
        __NVIC_DisableIRQ(TIMER0_IRQn);
        break;
    case 1:
        POWER_TurnOffPeripheral(POW_PCTIM1);

        ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->PR = 0;
        clear_match_regs(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) ));
    ...
    case 2:
        ...
        clear_match_regs(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) ));
        __NVIC_DisableIRQ(TIMER2_IRQn);
        break;
    case 3:
        POWER_TurnOffPeripheral(POW_PCTIM3);

        ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->PR = 0;
        clear_match_regs(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) ));
        __NVIC_DisableIRQ(TIMER3_IRQn);
        break;
    }
}
...
void TIMER_SetMatch(TIMER timer, TIMER_MatchRegister match_reg)
{
    if (match_reg.which >= 4 || match_reg.which < 0)
        return;

    switch (timer.which)
    {
    case 0:
        set_match_reg(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) ), match_reg);
        break;
    case 1:
        set_match_reg(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) ), match_reg);
        break;
    case 2:
        set_match_reg(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) ), match_reg);
        break;
    case 3:
        set_match_reg(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) ), match_reg);
        break;
    }
}
...
void TIMER_UnsetMatch(TIMER timer, TIMER_MatchRegister match_reg)
{
    ...
    {
    case 0:
        unset_match_reg(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) ), match_reg);
        break;
    case 1:
        unset_match_reg(((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) ), match_reg);
        break;
    case 2:
        unset_match_reg(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) ), match_reg);
        break;
    case 3:
        unset_match_reg(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) ), match_reg);
        break;
    }
}
...
void TIMER_Enable(TIMER timer)
{
    ...
    {
    case 0:
        (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR &= ~(1 << 1));
        (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR |= (1 << 0));
        break;
    case 1:
        (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR &= ~(1 << 1));
        (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR |= (1 << 0));
        break;
    case 2:
        (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR &= ~(1 << 1));
        (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR |= (1 << 0));
        break;
    case 3:
        (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR &= ~(1 << 1));
        (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR |= (1 << 0));
        break;
    }
}
...
_Bool TIMER_IsEnabled(TIMER timer)
{
    ...
    {
    case 0:
        return (((((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR) & (1 << 0)) == 1);
    case 1:
        return (((((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR) & (1 << 0)) == 1);
    case 2:
        return (((((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR) & (1 << 0)) == 1);
    case 3:
        return (((((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR) & (1 << 0)) == 1);
    }
