# 1 "Source/Libs/Button/button_irq.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/Libs/Button/button_irq.c" 2
...
# 2 "Source/Libs/Button/button_irq.c" 2
...
# 3 "Source/Libs/Button/button_irq.c" 2
...
# 5 "Source/Libs/Button/button_irq.c" 2
...
# 7 "Source/Libs/Button/button_irq.c" 2





static BUTTON_InterruptHandler handlers[BTN_INT_SRC_COUNT] = {0};


static u8 eint0_down, eint1_down, eint2_down;


extern _Bool debouncer_on;
...
extern void EINT0_IRQHandler(void)
{
    ...
    ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT &= 1;
}
